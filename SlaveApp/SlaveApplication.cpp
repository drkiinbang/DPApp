...
private:
    ...
    void printHelp() {
        std::cout << std::endl;
        std::cout << "=== DPApp Slave Console Commands ===" << std::endl;
        std::cout << "status        - Show worker status" << std::endl;
        std::cout << "stats         - Show processing statistics" << std::endl;
        std::cout << "tasks         - Show supported task types" << std::endl;
        std::cout << "queue         - Show task queue status" << std::endl;
