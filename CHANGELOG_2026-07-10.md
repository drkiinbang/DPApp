...
- `doc/handover/99_다음_릴리즈_Future_Works.md` §2.1 "KD-Tree 재사용" 항목: 코드 확인 결과 `IcpCore.hpp::runIcp()`에서 이미 반복문 바깥에서 KD-Tree를 1회만 생성하고 있음을 확인, "완료" 상태로 정정.
...
| `doc/handover/99_다음_릴리즈_Future_Works.md` | KD-Tree 재사용 항목 "완료"로 갱신 (부록 B) |
